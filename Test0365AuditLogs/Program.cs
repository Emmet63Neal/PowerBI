...
namespace Test0365AuditLogs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string connstring = "Server=tcp:pbitelemetry.database.windows.net,1433;Initial Catalog=PowerBITelemetry;Persist Security Info=False;User ID=pbi-admin;Password=c@t5rc00l;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
